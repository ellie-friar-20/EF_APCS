public class LorumIpsumStringMethods
{
    public static void main(String[] args)
    {
        ...
        System.out.println(indexNullam);
        System.out.println(newOccurance);
